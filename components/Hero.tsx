  ...
  return (
    <div className="container mx-auto  lg:flex mt-10 lg:gap-x-8 mb-28 lg:mb-36 xl:mb-52 items-start">
      ...
      <Image
        ...
        loading="lazy"
        alt="Айда к нам!"
        className="object-contain w-full mt-6 md:mt-6 lg:mt-0 relative lg:h-64 xl:h-80 xxl:h-auto "
      />
    </div>
  );
};
